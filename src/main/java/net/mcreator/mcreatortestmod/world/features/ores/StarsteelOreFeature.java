...
public class StarsteelOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("mcreator_test_mod:starsteel_ore", FEATURE,
				new OreConfiguration(StarsteelOreFeatureRuleTest.INSTANCE, McreatorTestModModBlocks.STARSTEEL_ORE.get().defaultBlockState(), 7));
	...
	private static class StarsteelOreFeatureRuleTest extends RuleTest {
		static final StarsteelOreFeatureRuleTest INSTANCE = new StarsteelOreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<StarsteelOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<StarsteelOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("mcreator_test_mod:starsteel_ore_match"), CUSTOM_MATCH);
		}
