...
public class BloodstoneBlockBlock extends McreatorTestModModElements.ModElement {
	@ObjectHolder("mcreator_test_mod:bloodstone_block")
	public static final Block block = null;

	public BloodstoneBlockBlock(McreatorTestModModElements instance) {
		super(instance, 32);
	}
