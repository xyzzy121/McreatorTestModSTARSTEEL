...
public class BloodstoneOreBlock extends McreatorTestModModElements.ModElement {
	@ObjectHolder("mcreator_test_mod:bloodstone_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mcreator_test_mod:bloodstone_ore_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 0)).range(7).square()
					.func_242731_b(1);
			event.getRegistry().register(feature.setRegistryName("bloodstone_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mcreator_test_mod:bloodstone_ore"), configuredFeature);
		}
	}
