...
public class HoneyBlock extends McreatorTestModModElements.ModElement {
	@ObjectHolder("mcreator_test_mod:honey")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("mcreator_test_mod:honey_bucket")
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes
						...
						.luminosity(1).density(1000).viscosity(1000).temperature(300)
		...
		elements.blocks
				.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER).hardnessAndResistance(100f).setLightLevel(s -> 1)) {
