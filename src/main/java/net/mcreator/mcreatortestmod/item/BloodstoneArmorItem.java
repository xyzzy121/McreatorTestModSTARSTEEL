...
public class BloodstoneArmorItem extends McreatorTestModModElements.ModElement {
	@ObjectHolder("mcreator_test_mod:bloodstone_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("mcreator_test_mod:bloodstone_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("mcreator_test_mod:bloodstone_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("mcreator_test_mod:bloodstone_armor_boots")
	public static final Item boots = null;

	public BloodstoneArmorItem(McreatorTestModModElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(TestItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "mcreator_test_mod:textures/models/armor/bloodstone_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				ArmorCheatProcedureProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
